...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "FIFO 16.pyw"
 
        #Name of program
        self.project_name = "FIFO 16"
        ...
        #Auhor of program
        self.author_name = "Julian Sam"
        self.author_email = "juliansam72@gmail.com"
        self.copyright = "Copyright (c) 2016 Me."
 
        #Description
        self.project_description = "FIFO 16, a fun 2D football game."
